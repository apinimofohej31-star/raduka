...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "admin": "He is  Moniruzzaman Monir  তাকে সবাই Admin Monir হিসেবে চিনে😘☺️",
    ...
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss  এর মনির ইনবক্সে গুতা দিন 😘",
    ...
    "valo aso": "হ্যাঁ রে প্রিও, বস মনির এর দোয়ায় ভালো আছি 😌💞",
